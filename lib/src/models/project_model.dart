...
class ProjectModel {
  ...
  factory ProjectModel.fromJson(Map<String, dynamic> json) => ProjectModel(
        ...
        priorityDefault: json["priority_default"].toString(),
        priorityStart: json["priority_start"].toString(),
        priorityEnd: json["priority_end"].toString(),
        email: json["email"],
        predefinedEmailSubjects: json["predefined_email_subjects"],
        perSwimlaneTaskLimits: json["per_swimlane_task_limits"].toString(),
        taskLimit: json["task_limit"].toString(),
        enableGlobalTags: json["enable_global_tags"].toString(),
